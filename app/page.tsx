...
export default async function Home() {
  ...
  const personSchema = {
    ...
    image: 'https://www.jintasit.com/images/profile.jpg',
    sameAs: [
      'https://github.com/jintasit-yothee',
      'https://www.linkedin.com/in/jintasit-yothee/',
      'https://x.com/jyo_no6',
    ],
  };
    ...
    <main className={styles.main}>
      ...
      <div className={styles.intro}>
        ...
        <Image
          ...
          alt="Jintasit Yothee - Full Stack Software Engineer headshot"
          width={200}
          height={200}
        ...
        <div style={{ display: "flex", gap: "16px" }}>
          <a href="https://github.com/jintasit-yothee" target="_blank" rel="noopener noreferrer me" title="GitHub">
            <svg
              width="32"
              height="32"
              viewBox="0 0 24 24"
          ...
          <a href="https://www.linkedin.com/in/jintasit-yothee/" target="_blank" rel="noopener noreferrer me" title="LinkedIn">
            <svg
              width="32"
              height="32"
              viewBox="0 0 24 24"
          ...
          <a href="https://x.com/jyo_no6" target="_blank" rel="noopener noreferrer me" title="X (Twitter)">
            <svg
              width="32"
              height="32"
              viewBox="0 0 24 24"
      ...
      <nav className={styles.nav}>
        ...
        <span>|</span>
        <a href="https://www.linkedin.com/in/jintasit-yothee/" target="_blank" rel="noopener noreferrer me">Experience</a>
        <span>|</span>
